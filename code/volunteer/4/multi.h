from  [Math&Compution-巨大素数と計算機-C 言語サンプルプログラム]
...
void LeftShift(unsigned a[], long int sh);
void LongLeftShift(unsigned a[], long int sh);
void RightShift(unsigned a[], long int sh);
void LongRightShift(unsigned a[], long int sh);
